...
COPY public.actors (id, firstname, lastname, age, film) FROM stdin;
1	Christopher	Carley	44	Gran Torino
2	Hilary	Swank	48	Million Dollar Baby
\.
...
COPY public.films (id, title, year, producer) FROM stdin;
1	The Good, the Bad and the Ugly	1966	Clint Eastwood
2	Gran Torino	2008	Clint Eastwood
...
COPY public.producers (id, firstname, lastname, age, film) FROM stdin;
1	Clint	Istwood	92	Million Dollar Baby
\.
